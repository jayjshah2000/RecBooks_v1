...
class _SelectedBookScreenState extends State<SelectedBookScreen> {
  ...
  // void initState() {
  //   super.initState();
  //   getRecommendedBookData = getRecommendedBookData(widget.book.title);
  // }
...
// }
  ...
  Widget build(BuildContext context) {
    String _url = 'https://www.amazon.in/s?k=' + widget.book.title.replaceAll(RegExp(' '), '%20') +"%20" + widget.book.author.replaceAll(RegExp(' '), '%20');
    return Scaffold(
      bottomNavigationBar: Row(
        children: <Widget>[
          Container(
            margin: const EdgeInsets.only(left: 10, right: 5, bottom: 25),
            height: 49,
          ...
          // SizedBox(width: 55),
          Container(
            margin: const EdgeInsets.only(left: 5, right: 10, bottom: 25),
            height: 49,
